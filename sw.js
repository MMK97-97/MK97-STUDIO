const CACHE='mk97-app-shell-v2';
const SHELL=['./','./index.html','./templates.html','./projects.html','./tools.html','./poster.html','./video.html','./library.html','./more.html','./mk97-app.css','./mk97-app.js'];
